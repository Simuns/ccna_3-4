 ...
 * cookie
 */
$cfg['blowfish_secret'] = 'LGmE0ESkgibd86bwaJo0xcKfh5J5wud3'; /* YOU MUST FILL IN THIS FOR COOKIE AUTH! */
...
$i++;
$cfg['Servers'][$i]['host'] = 'sql.linuxgruppe4.local'; //provide hostname and port if other than default
$cfg['Servers'][$i]['user'] = 'service_sql';   //user name for your remote server
$cfg['Servers'][$i]['password'] = 'grindspikeplir';  //password
$cfg['Servers'][$i]['auth_type'] = 'config';     

/*
$cfg['Servers'][$i]['host'] = 'sql.linuxgruppe4.local'; //provide hostname and port if other than default
$cfg['Servers'][$i]['user'] = 'root';   //user name for your remote server
$cfg['Servers'][$i]['password'] = '<<<<<INSERTSUPERSECRETPASSWORDHERE>>>>';  //password
$cfg['Servers'][$i]['auth_type'] = 'config';    
*/
?>
